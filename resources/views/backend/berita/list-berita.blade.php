    ...
    <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-auto ml-auto">
            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{ route('berita.index') }}" method="get">
                ...
                <tbody>
                    ...
                    @foreach ($berita as $value)
                        <tr>
                            ...
                            <td> <img src="{{ asset('backend/img/berita') . '/' . $value->foto }}" alt="" width="200px"></td>
                            <td>{!!implode(' ', array_slice(explode(' ', $value->konten), 0, 20))!!}...</td>
                            <td class="text-center">
                                <div class="dropdown dropdown-link">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="{{ route('berita.edit', $value) }}" class="dropdown-item">{{ __('Edit') }}</a>
                                        <form action="{{ route('berita.destroy', $value) }}" method="post">
                                            @csrf
                                            @method('delete')

    ...
    <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-auto ml-auto">
            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{ route('galeri.index') }}" method="get">
                ...
                <tbody>
                    ...
                    @foreach ($galeri as $value)
                        <tr>
                            <td>{{$no}}</td>
                            <td>{{$value->judul}}</td>
                            <td> <img src="{{ asset('backend/img/galeri') . '/' . $value->foto }}" alt="" width="200px"></td>
                            ...
                            <td class="text-center">
                                <div class="dropdown dropdown-link">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="{{ route('galeri.edit', $value) }}" class="dropdown-item">{{ __('Edit') }}</a>
                                        <form action="{{ route('galeri.destroy', $value) }}" method="post">
                                            @csrf
                                            @method('delete')
